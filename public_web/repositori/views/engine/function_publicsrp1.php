...
function fnInsertDokSokongan($namaDokAsal,$namaDokDisimpan){
    ...
    $semakBilDokSql = "SELECT kod_dok FROM dokumen";
...
function fnCheckSavedDivisionCodeToAdd($a,$b,$c,$d){
    ...
    $kod_bah = $_SESSION['loggedin_kod_bah'];
...
function fnCheckSavedDivisionNameToAdd($a,$b,$c,$d){
    ...
    $kod_bahagian = $_SESSION['loggedin_kod_bah'];
    $nama_bahagian = $_SESSION['nama_bahagian'];
...
function fnShowDocReportSelectYear1($a,$b,$c,$d,$e,$f,$g){
    $DBServer       = $a; // e.g 'localhost' or '192.168.1.100'
    $DBUser         = $b;
    $DBPass         = $c;
    $DBName         = $d;
    ...
    if (isset($_SESSION['doclist_search_keyword']) != "") {
        ...
        fnRunAlert("Bukan Carian");
        // $sql="SELECT kod_dok, tajuk_dok, bil_dok, tahun_dok, kod_kat FROM dokumen ORDER BY kod_kat ASC, tahun_dok DESC, bil_dok ASC, tajuk_dok ASC";
        $sql="SELECT DISTINCT tahun_dok FROM dokumen ORDER BY tahun_dok DESC";
...
function fnShowDocReportBySec($a,$b,$c,$d,$e,$f,$g){
    ...
    if (isset($_SESSION['doclist_search_keyword']) != "") {
        $doclist_search_keyword = $_SESSION['doclist_search_keyword'];
        $sql="SELECT * FROM sektor WHERE nama_sektor LIKE '%$doclist_search_keyword%' AND kod_sektor != 1 ORDER BY nama_sektor ASC";
    }
    else {
        $sql="SELECT * FROM sektor WHERE kod_sektor != 1 ORDER BY nama_sektor ASC";
    }
...
function fnShowDocReportByStat($a,$b,$c,$d,$e,$f,$g){
    ...
    if (isset($_SESSION['doclist_search_keyword']) != "") {
        $doclist_search_keyword = $_SESSION['doclist_search_keyword'];
        $sql="SELECT * FROM status WHERE nama_status LIKE '%$doclist_search_keyword%' AND kod_status != 1 ORDER BY nama_status ASC";
    }
    else {
        $sql="SELECT * FROM status WHERE kod_status != 1 ORDER BY nama_status ASC";
    }
...
function fnShowDocTableContentNewStyle($a,$b,$c,$d){
    $DBServer       = $a; // e.g 'localhost' or '192.168.1.100'
    $DBUser         = $b;
    $DBPass         = $c;
    $DBName         = $d;
    ...
    elseif (isset($_SESSION['jenis_senarai']) AND $_SESSION['jenis_senarai'] == "s" AND $_SESSION['sumber_senarai'] == "l") {
        ...
        if ($kod_status_dipilih == 4) {
            $sql="SELECT a.kod_dok, a.tajuk_dok, a.bil_dok, a.tahun_dok, a.kod_kat, b.nama_kat, a.tarikh_wujud, c.nama_status, a.des_dok, d.nama_jab, a.tajuk_dok_baharu FROM dokumen as a, kategori as b, status as c, jabatan as d WHERE a.kod_kat = b.kod_kat AND a.kod_status = c.kod_status AND a.kod_status = $kod_status_dipilih AND a.kod_jab_baharu = d.kod_jab ORDER BY a.kod_kat ASC, a.tahun_dok DESC, a.bil_dok ASC, a.tajuk_dok ASC";
        }
        else {
    ...
    elseif (isset($_SESSION['doclist_search_keyword']) <> "") {
...
function fnShowDocTableContentForSimpleSearch($a,$b,$c,$d,$e,$f,$g){
    $DBServer       = $a; // e.g 'localhost' or '192.168.1.100'
    $DBUser         = $b;
    $DBPass         = $c;
    $DBName         = $d;
...
function fnShowViewDocContent1($a,$b,$c,$d,$e,$f,$g){
    $DBServer       = $a;
    $DBUser         = $b;
    $DBPass         = $c;
    $DBName         = $d;
...
function fnSearchDocAdvanced(){
    ...
    if (isset($_SESSION['kombinasi_cl_dok']) != "") {
        ...
        # 100000
        elseif ($_SESSION['kombinasi_cl_dok'] === 32) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 32;
        }
        # 100001
        elseif ($_SESSION['kombinasi_cl_dok'] === 33) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 33;
        }
        # 100010
        elseif ($_SESSION['kombinasi_cl_dok'] === 34) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 34;
        }
        # 100011
        elseif ($_SESSION['kombinasi_cl_dok'] === 35) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 35;
        }
        # 100100
        elseif ($_SESSION['kombinasi_cl_dok'] === 36) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_sektor = '$kod_sektor' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 36;
        }
        # 100101
        elseif ($_SESSION['kombinasi_cl_dok'] === 37) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_sektor = '$kod_sektor' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 37;
        }
        # 100110
        elseif ($_SESSION['kombinasi_cl_dok'] === 38) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 38;
        }
        # 100111
        elseif ($_SESSION['kombinasi_cl_dok'] === 39) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 39;
        }
        # 101000
        elseif ($_SESSION['kombinasi_cl_dok'] === 40) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 40;
        }
        # 101001
        elseif ($_SESSION['kombinasi_cl_dok'] === 41) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 41;
        }
        # 101010
        elseif ($_SESSION['kombinasi_cl_dok'] === 42) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 42;
        }
        # 101011
        elseif ($_SESSION['kombinasi_cl_dok'] === 43) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 43;
        }
        # 101100
        elseif ($_SESSION['kombinasi_cl_dok'] === 44) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 44;
        }
        # 101101
        elseif ($_SESSION['kombinasi_cl_dok'] === 45) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 45;
        }
        # 101110
        elseif ($_SESSION['kombinasi_cl_dok'] === 46) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 46;
        }
        # 101111
        elseif ($_SESSION['kombinasi_cl_dok'] === 47) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 47;
        }
        # 110000
        elseif ($_SESSION['kombinasi_cl_dok'] === 48) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 48;
        }
        # 110001
        elseif ($_SESSION['kombinasi_cl_dok'] === 49) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 49;
        }
        # 110010
        elseif ($_SESSION['kombinasi_cl_dok'] === 50) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 50;
        }
        # 110011
        elseif ($_SESSION['kombinasi_cl_dok'] === 51) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%' AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 51;
        }
        # 110100
        elseif ($_SESSION['kombinasi_cl_dok'] === 52) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_sektor = '$kod_sektor' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 52;
        }
        # 110101
        elseif ($_SESSION['kombinasi_cl_dok'] === 53) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_sektor = '$kod_sektor' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 53;
        }
        # 110110
        elseif ($_SESSION['kombinasi_cl_dok'] === 54) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 54;
        }
        # 110111
        elseif ($_SESSION['kombinasi_cl_dok'] === 55) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%' AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 55;
        }
        # 111000
        elseif ($_SESSION['kombinasi_cl_dok'] === 56) {        
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 56;
        }
        # 111001
        elseif ($_SESSION['kombinasi_cl_dok'] === 57) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 57;
        }
        # 111010
        elseif ($_SESSION['kombinasi_cl_dok'] === 58) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 58;
        }
        # 111011        
        elseif ($_SESSION['kombinasi_cl_dok'] === 59) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 59;
        }
        # 111100
        elseif ($_SESSION['kombinasi_cl_dok'] === 60) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 60;
        }
        # 111101
        elseif ($_SESSION['kombinasi_cl_dok'] === 61) {
            $sql = "SELECT * FROM dokumen WHERE tahun_dok LIKE '%$cl_tahun_dokumen%' AND tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 61;
        }
        # 111110
        elseif ($_SESSION['kombinasi_cl_dok'] === 62) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%' AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 62;
        }
        # 111111
        elseif ($_SESSION['kombinasi_cl_dok'] === 63) {
            $sql = "SELECT * FROM dokumen WHERE tajuk_dok LIKE '%$cl_tajuk_dokumen%'  AND tahun_dok LIKE '%$cl_tahun_dokumen%' AND kod_kat = '$kod_kat' AND kod_sektor = '$kod_sektor' AND kod_bah = '$kod_bah' AND kod_status = '$kod_status' AND kod_kem = '$kod_kem' AND kod_jab = '$kod_jab' AND tanda_hapus<>0 AND bil_dok<>0";
            $marker = 63;
        }
    # larikan pernyataan
    $_SESSION['sqlforadvanceddocsearch'] = "";
...
function fnVerifyLogin($a,$b,$c,$d,$e,$f){
    ...
    if ($rows_returned === 1) {
        ...
        foreach($arr as $row) {
			...
			$_SESSION['loggedin_kod_bah'] = $row['kod_bah'];

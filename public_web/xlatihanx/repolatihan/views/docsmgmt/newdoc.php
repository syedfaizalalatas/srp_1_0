...
if (isset($_POST['btn_simpan_dok_baru']) AND !isset($_GET['s'])) {
  ...
  if ($_SESSION['verifiedOK'] != 0) {
    ...
    if ($_SESSION['touploadOK'] == 1 AND $_SESSION['verifiedOK'] == 1) {
      # baru boleh upload file
      $_SESSION['uploadOk'] = 0; // Assign initial value to 'uploadOk'
      fnUploadFilesRename(); // the altered original version (the working one! 20161018)
    ...
    elseif ($_SESSION['uploadOk'] == 0 OR $_SESSION['verifiedOK'] == 0) {
              ...
              <form id="form-dok-baharu" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="newdoc.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input value="<?php echo $_SESSION['bil_dok']; ?>" type="text" id="bil_dokumen" name="bil_dokumen" required class="form-control col-md-7 col-xs-12" maxlength="3" pattern="\d{1,3}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input value="<?php echo $_SESSION['tajuk_dok']; ?>" type="text" id="tajuk_dokumen" name="tajuk_dokumen" required class="form-control col-md-7 col-xs-12" maxlength="150"/>
                  </div>
                </div>
                <div class="form-group">

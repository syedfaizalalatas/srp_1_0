...
$_SESSION['page_title'] = "Senarai Dokumen";
...
$_SESSION['table_title'] = "Semua Kategori Dokumen";
$_SESSION['table_action'] = "Senaraikan Dokumen";
$actionfilename = "docreport_all.php";
$table01name = "dokumen";
$field01name = "kod_dok";
          ...
          <div class="x_content">
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody id="myTableBody">
                <?php 
                fnShowDocReportAllContent($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
                ?>
              </tbody>
            </table>
            </form>
